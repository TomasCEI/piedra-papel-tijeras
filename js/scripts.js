...
function AIvsAI(){
    ...
    // setInterval("una función", "cada cuanto lo voy a hacer");
    intervaloAI = setInterval( () => {
        const Humano=elegirAutomaticamente(); // piedra o papel o tijera
        jugar(Humano);
    }  , 1000); // 1 seg = 1000 mili segundos
}
...
function mostrarEstadisticas(){
    ...
    txtEstadisticas.innerHTML =`
        <div>
            ...
            <h3>Stats Usuario:</h3>
                👊🏻 ${objPuntaje.stats.user_piedra} -  ✋🏻 ${objPuntaje.stats.user_papel} - ✌🏻 ${objPuntaje.stats.user_tijera}
        </div>`;
...
function resetStats(){
    ...
    // borro el intervalo de AI en caso de haberlo iniciado
